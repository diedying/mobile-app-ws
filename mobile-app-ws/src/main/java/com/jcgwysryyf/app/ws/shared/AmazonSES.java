...
public class AmazonSES {
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://http://ec2-34-203-195-113.compute-1.amazonaws.com:8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
		      ...
		      + "<a href='http://http://ec2-34-203-195-113.compute-1.amazonaws.com:8080/verification-service/password-reset.html?token=$tokenValue'>"
